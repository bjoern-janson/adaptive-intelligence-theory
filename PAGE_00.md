# Adaptive Intelligence Theory — Minimal Formal Skeleton (v0.1)

## Core Definition

Intelligence is the expansion of controllable reachability through improved representations while preserving the causal access required for continued correction and adaptation.
...
\frac{d\Omega}{dt} &= f_\Omega(R,I) \\[4pt]
\frac{dC}{dt} &= f_C(\Omega,R_e) \\[4pt]
\frac{dA}{dt} &= f_A(C,E)
\end{aligned}
}
$$
...
> The rate at which a system expands its ability to affect the world must remain bounded by its ability to receive and incorporate corrective information from reality.
...
- Evolution: selection + ecological feedback
- Science: experiments + criticism
...
> How can systems increase their ability to transform reality without losing their ability to learn from reality?
